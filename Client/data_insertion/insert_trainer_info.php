...
<div class="Containe w-full">
    <div class="">
        ...
        <table>
            ...
            <tr>
                <td class="flex flex-col justify-around">Date of Birth<input type="date" id="date_of_birth" name="date_of_birth" onblur="getAget()"></td>
            ...
            <tr>
                ...
                <input type="file" name="image_t" id="image">
                <button type="submit" id="save" onclick="saveTrainerInfo()" class="border w-20 text-white bg-orange-400 hover:bg-orange-500 px-2 py-1 rounded-md mt-5 mb-8 ease-in-out duration-500">Submit</button>
                </td>
            </tr>
        </table>
</div>
