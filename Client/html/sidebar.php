...
<aside class="bg-gray-900 h-screen text-white">
    ...
    <div class="sidebar">
        ...
        <div class="cursor-pointer mb-4">
            ...
            <a href="#" class="ml-1 mb-1 flex align" onclick="changeContent('AddandEditMembership')"><span class="material-symbols-outlined">chevron_right</span>Add&Edit Membership</a>
            </div>
        </div>
        ...
        <div class="cursor-pointer mb-4">
            ...
            <div class="submenue flex flex-col">
                ...
                <a href="#" class="ml-1 mb-1 flex align" onclick="changeContent('Viewtrainerinfo')"><span class="material-symbols-outlined">chevron_right</span>View Trainer Details</a>
            </div>
        </div>
